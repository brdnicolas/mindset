  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={1.5}
      />
      <path d="M3 13h18" stroke="currentColor" strokeWidth={1.5} strokeLinejoin="round" />
      <path d="M7 16.5h4" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
