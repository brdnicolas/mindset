...
export const KeyRightIcon = ({ className }: IconProps) => {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      ...
      />
      <path
        d="M15.5 12H8M12 17l1.606-1.606c1.188-1.188 1.782-1.782 2.005-2.467a3 3 0 000-1.854c-.223-.685-.817-1.28-2.005-2.467L12 7"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
