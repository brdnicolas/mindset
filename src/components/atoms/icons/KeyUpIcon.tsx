...
export const KeyUpIcon = ({ className }: IconProps) => {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      ...
      />
      <path
        d="M12 8.5V16M17 12l-1.606-1.606c-1.188-1.188-1.782-1.782-2.467-2.005a3 3 0 00-1.854 0c-.685.223-1.28.817-2.467 2.005L7 12"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
