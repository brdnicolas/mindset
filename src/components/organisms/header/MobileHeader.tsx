...
import { isActivePath, SECONDARY_ROUTES } from '@/utils/routing/routing'
  ...
  return (
    <div className="p-5 w-full flex justify-between">
      <div className="flex items-center">
        <button onClick={() => goTo('/')}>
          <img className="h-10" src="/assets/tinyLogo.png" alt="Logo " />
        </button>
        <Avatar
      ...
      <div className="flex items-center ml-auto w-fit gap-3">
